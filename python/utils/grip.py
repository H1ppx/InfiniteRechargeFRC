...
class GripRetroreflectivePipeline:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_hue = [62.975025335144, 93.6342982296323]
        self.__hsv_threshold_saturation = [0.0, 255.0]
        self.__hsv_threshold_value = [56.564752210816025, 220.1877133105802]
        ...
        self.__filter_contours_solidity = [0.0, 35.72241291658057]
